...
pub extern fn DrawLineBSpline(points: [*c]Vector2, pointCount: c_int, thick: f32, color: Color) void;
pub extern fn DrawLineCatmullRom(points: [*c]Vector2, pointCount: c_int, thick: f32, color: Color) void;
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /Users/endi/project/zig/zig_raylib_series/libs/raylib/src/raylib.h:122:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // /Users/endi/project/zig/zig_raylib_series/libs/raylib/src/raylib.h:125:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // /Users/endi/project/zig/zig_raylib_series/libs/raylib/src/raylib.h:128:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // /Users/endi/project/zig/zig_raylib_series/libs/raylib/src/raylib.h:131:13
